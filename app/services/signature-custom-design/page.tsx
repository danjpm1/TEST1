...
export default function SignatureCustomDesignPage() {
  ...
  const steps = [
    {
      title: "Envision",
      description: "We translate your dreams into stunning architectural blueprints with unmatched creativity.",
      image: "/aerial.jpg",
      alt: "Luxury home aerial view with pool",
    },
    {
      title: "Craft",
      description: "Every detail is meticulously crafted by master artisans using only the finest materials.",
      image: "/luxury-modern-cabin-interior-with-large-windows-wo1.jpg",
      alt: "Custom interior craftsmanship",
    },
    {
      title: "Reveal",
      description: "Experience the unveiling of your one-of-a-kind masterpiece — a home unlike any other.",
      image: "/modern-luxury-home-at-night-with-warm-interior-lig.jpg",
      alt: "Completed signature home at night",
    },
  ]
  ...
  return (
    <div className="w-full overflow-x-hidden bg-black">
      ...
      {/* Hero Section with SIGNATURE CUSTOM DESIGN text */}
      <section className="relative w-full">
        <div className="flex items-center justify-end px-4 sm:px-8 md:pr-24 lg:pr-32 h-[30vh] bg-black">
          <h1 className="text-[1.5rem] sm:text-[2rem] md:text-[3.5rem] lg:text-[4.5rem] font-bold text-white tracking-tight text-right">
        ...
        <div className="relative w-full h-[70vh]">
          <Image
            src="/luxury-modern-living-room-wood-ceiling-concrete-fi.jpg"
            alt="Luxury custom designed home interior"
            fill
      ...
      {/* Exclusive + Bespoke Section - Matched renovation format */}
          ...
          <div className="grid lg:grid-cols-2 gap-6 md:gap-16 mb-10 md:mb-20">
            ...
            <div className="space-y-4 md:space-y-6 text-[15px] md:text-lg text-gray-300 mt-4 lg:mt-0">
              <p className="leading-[1.7] md:leading-8">
                Personalized luxury living. We create extraordinary residences as unique as the individuals who inhabit
                them.
              </p>
              <p className="leading-[1.7] md:leading-8">
                Our bespoke approach means every element — from architectural vision to interior finishes — is tailored
                exclusively to your lifestyle. Working with world-class architects, we craft homes that transcend
                boundaries.
              </p>
