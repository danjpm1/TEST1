...
export default function EngineeringConsultingPage() {
  ...
  const steps = [
    {
      title: "Analysis",
      description: "Comprehensive structural analysis and feasibility studies for your project requirements.",
      image: "/aerial.jpg",
      alt: "Engineering analysis and planning",
    },
    {
      title: "Design",
      description: "Expert engineering design solutions with innovative approaches to complex challenges.",
      image: "/luxury-modern-cabin-interior-with-large-windows-wo1.jpg",
      alt: "Engineering design phase",
    },
    {
      title: "Implementation",
      description: "Seamless execution with ongoing consulting support throughout the build process.",
      image: "/modern-luxury-home-at-night-with-warm-interior-lig.jpg",
      alt: "Engineering implementation",
    },
  ]
  ...
  return (
    <div className="w-full overflow-x-hidden bg-black">
      ...
      {/* Hero Section with ENGINEERING & CONSULTING text */}
      <section className="relative w-full">
        <div className="flex items-center justify-end px-4 sm:px-8 md:pr-24 lg:pr-32 h-[31.5vh] bg-black">
          <h1 className="text-[2rem] sm:text-[2.8rem] md:text-[3.8rem] lg:text-[5rem] font-bold text-white tracking-tight text-right leading-[0.85]">
            ENGINEERING &<br />
            CONSULTING
          </h1>
        </div>
        ...
        <div className="relative w-full h-[70vh]">
          <Image
            ...
            alt="Engineering and consulting services"
            fill
          ...
          <div className="grid lg:grid-cols-2 gap-6 md:gap-16 mb-10 md:mb-20">
            ...
            <div className="space-y-4 md:space-y-6 text-[15px] md:text-lg text-gray-300 mt-4 lg:mt-0">
              <p className="leading-[1.7] md:leading-8">
                Antova Builders brings engineering excellence to every project — combining technical expertise with
                innovative solutions for complex structural challenges.
              </p>
              <p className="leading-[1.7] md:leading-8">
                Our consulting services ensure your project is built on a foundation of precision, safety, and
                forward-thinking design principles.
              </p>
              <p className="font-semibold text-white pt-1 md:pt-2">Smart solutions, lasting results.</p>
            </div>
          </div>
        </div>
