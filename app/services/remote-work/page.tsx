...
export default function RemoteWorkPage() {
  ...
  const steps = [
    {
      title: "Consultation",
      description: "We meet you anywhere to understand your vision, terrain, and design goals.",
      image: "/aerial.jpg",
      alt: "Remote consultation site visit",
    },
    {
      title: "Execution",
      description: "Our expert team manages every build on-site with precision and care.",
      image: "/luxury-modern-cabin-interior-with-large-windows-wo1.jpg",
      alt: "On-site construction execution",
    },
    {
      title: "Completion",
      description: "Seamless delivery — your project, ready to stand the test of time.",
      image: "/modern-luxury-home-at-night-with-warm-interior-lig.jpg",
      alt: "Completed remote build",
    },
  ]
  ...
  return (
    <div className="w-full overflow-x-hidden bg-black">
      ...
      {/* Hero Section with REMOTE WORK text */}
          ...
          <div className="grid lg:grid-cols-2 gap-6 md:gap-16 mb-10 md:mb-20">
            ...
            <div className="space-y-4 md:space-y-6 text-[15px] md:text-lg text-gray-300 mt-4 lg:mt-0">
              <p className="leading-[1.7] md:leading-8">
                We build where few can — from remote landscapes and mountain terrains to coastal slopes. Our adaptable
                team is equipped to manage every stage with precision, regardless of distance or difficulty.
              </p>
              <p className="leading-[1.7] md:leading-8">
                Through advanced planning, engineering innovation, and seamless coordination, we turn challenging
                locations into architectural achievements that stand strong for generations.
              </p>
